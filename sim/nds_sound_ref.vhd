...
-- VERBATIM COPY of rtl/nds_sound.vhd as of commit e092dc4, with only the entity
-- and architecture names changed. Do not "improve" anything in here: its whole
-- value is being the thing the refactor is compared against, so any edit that is
-- not a mechanical rename destroys the reference.
--
-- Same role as sim/nds_drawer_text_ref.vhd plays for the text drawer.
-- Regenerate with: sim/regen_sound_ref.sh
-- SPDX-License-Identifier: GPL-2.0-or-later
...
architecture arch of nds_sound_ref is
