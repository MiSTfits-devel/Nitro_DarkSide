...
begin
   ...
   process (clk)
      ...
      variable eva_eff            : integer range 0 to 16;
      variable evb_eff            : integer range 0 to 16;
   begin
      if rising_edge(clk) then
         ...
         if (pixeldata_obj_cycle3(OBJBITMAP) = '1' and firstprio_cycle3(4 downto 0) = "10000") then
